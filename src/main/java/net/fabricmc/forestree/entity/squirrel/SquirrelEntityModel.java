...
public class SquirrelEntityModel extends EntityModel<SquirrelEntity> {
    ...
    public SquirrelEntityModel(ModelPart modelPart) {
    ...
    @Override
    public void setAngles(SquirrelEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
